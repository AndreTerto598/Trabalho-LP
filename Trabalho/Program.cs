...
namespace Trabalho
{
        class Program {
            ...
            estoque.Adicionar(rwindols, 5);
                ...
                estoque.Adicionar(premillere, 5);
            ...
            Cliente hermenegildo = new Cliente("Hermenegildo Benevides", "123.456.789-10");
                ...
                carrinhoZoroastra.Adicionar(rwindols, 3);
                carrinhoZoroastra.Adicionar(alface123, 3);
                carrinhoZoroastra.Adicionar(cottonshopi, 5);
                ...
                Relatorio relatorioClientes = new Relatorio("Relatório de Clientes",
                   "Esse relatório apresenta uma lista de todos os clientes que compraram no mês");
            ...
            Relatorio relatorioCompras = new Relatorio("Relatório de Compra",
                   "Esse relatório apresenta uma lista de todos as compras que ocorreram no mês de abril");
